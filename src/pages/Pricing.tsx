              ...
              <div className="pb-24">
                <div className="container mx-auto px-4">
                  ...
                  <div className="max-w-2xl mx-auto mb-14">
                    <div className="bg-gradient-to-r from-[hsl(210,90%,55%)]/5 via-[hsl(190,85%,50%)]/5 to-[hsl(270,70%,60%)]/5 border border-[hsl(210,90%,55%)]/20 rounded-2xl p-6 text-center">
                      <div className="flex items-center justify-center gap-3 mb-3">
                        <div className="w-10 h-10 rounded-xl bg-gradient-to-r from-[hsl(210,90%,55%)]/10 to-[hsl(270,70%,60%)]/10 flex items-center justify-center">
                          <Clock className="w-5 h-5 text-[hsl(210,90%,55%)]" />
                        </div>
                    ...
                    {projectPackages.map((pkg, i) => (
                      <motion.div
                        ...
                        className={`relative rounded-2xl border p-8 transition-all duration-500 hover:-translate-y-2 flex flex-col ${
                          pkg.highlighted
                            ? "bg-white border-[hsl(210,90%,55%)]/40 shadow-[0_0_50px_rgba(46,168,255,0.12)] ring-1 ring-[hsl(210,90%,55%)]/20"
                            : "bg-white border-[#D1D5DB] hover:border-[hsl(210,90%,55%)]/30 hover:shadow-lg"
                        }`}
                      >
                        {pkg.badge && (
                        ...
                        <div className="space-y-2.5 mb-6 flex-1">
                          {pkg.features.map((f) => (
                            <div key={f} className="flex items-start gap-2.5">
                              <Check className="w-4 h-4 text-[hsl(210,90%,55%)] mt-0.5 flex-shrink-0" />
                        ...
                        <div className="mb-6">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {pkg.phases.map((phase, pi) => (
                              <span key={phase} className="inline-flex items-center gap-1 text-xs bg-gradient-to-r from-[hsl(210,90%,55%)]/5 to-[hsl(270,70%,60%)]/5 text-[hsl(210,90%,55%)] px-3 py-1.5 rounded-full border border-[hsl(210,90%,55%)]/15">
                                <span className="w-4 h-4 rounded-full bg-gradient-to-r from-[hsl(210,90%,55%)] to-[hsl(270,70%,60%)] text-white flex items-center justify-center text-[9px] font-bold">{pi + 1}</span>
                                {phase}
                              </span>
                            ))}
                          </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                      {projectCostFactors.map((item, i) => (
                        <motion.div
                          ...
                          className="bg-white border border-[#D1D5DB] rounded-2xl p-5 text-center hover:border-[hsl(210,90%,55%)]/40 hover:shadow-lg transition-all duration-300 group"
                        >
                          <div className="w-12 h-12 mx-auto mb-3 rounded-xl bg-gradient-to-r from-[hsl(210,90%,55%)]/8 to-[hsl(270,70%,60%)]/8 flex items-center justify-center group-hover:from-[hsl(210,90%,55%)]/15 group-hover:to-[hsl(270,70%,60%)]/15 transition-colors">
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16 max-w-5xl mx-auto">
                    {retainerTiers.map((tier, i) => (
                      ...
                      >
                        ...
                        {/* Hours circle */}
                        <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-[hsl(210,90%,55%)]/10 to-[hsl(270,70%,60%)]/10 flex items-center justify-center border border-[hsl(210,90%,55%)]/20">
                          <span className="text-2xl font-bold bg-gradient-to-r from-[hsl(210,90%,55%)] to-[hsl(270,70%,60%)] bg-clip-text text-transparent">{tier.hours}</span>
                        </div>
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                      {rateFactors.map((factor, i) => (
                        <motion.div
                          ...
                          className="bg-white border border-[#D1D5DB] rounded-2xl p-6 hover:border-[hsl(210,90%,55%)]/30 hover:shadow-lg transition-all duration-300 group"
                        >
                          <div className="w-11 h-11 rounded-xl bg-gradient-to-r from-[hsl(210,90%,55%)]/8 to-[hsl(270,70%,60%)]/8 flex items-center justify-center mb-3 group-hover:from-[hsl(210,90%,55%)]/15 group-hover:to-[hsl(270,70%,60%)]/15 transition-colors">
                            <factor.icon className="w-5 h-5 text-[hsl(210,90%,55%)]" />
                          </div>
                        ...
                        <div className="grid sm:grid-cols-2 gap-4 mb-10">
                          {[
                            ...
                            <div key={f} className="flex items-center gap-3">
                              <div className="w-6 h-6 rounded-full bg-gradient-to-r from-[hsl(210,90%,55%)]/10 to-[hsl(270,70%,60%)]/10 flex items-center justify-center flex-shrink-0">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {partnerBenefits.map((benefit, i) => (
                        <motion.div
                          ...
                          viewport={{ once: true }}
                          transition={{ delay: i * 0.1 }}
                          className="bg-white border border-[#D1D5DB] rounded-2xl p-7 hover:border-[hsl(210,90%,55%)]/30 hover:shadow-xl transition-all duration-300 group"
                        >
                          <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-[hsl(210,90%,55%)]/10 to-[hsl(270,70%,60%)]/10 flex items-center justify-center mb-4 group-hover:from-[hsl(210,90%,55%)]/20 group-hover:to-[hsl(270,70%,60%)]/20 transition-colors">
                            <benefit.icon className="w-6 h-6 text-[hsl(210,90%,55%)]" />
                          </div>
                    ...
                    <div className="bg-white border border-[#D1D5DB] rounded-2xl p-8">
                      <div className="grid sm:grid-cols-2 gap-5">
                        {investmentFactors.map((factor, i) => (
                          ...
                          >
                            <div className="w-8 h-8 rounded-lg bg-gradient-to-r from-[hsl(210,90%,55%)]/10 to-[hsl(270,70%,60%)]/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                              <Check className="w-4 h-4 text-[hsl(210,90%,55%)]" />
                            </div>
                            <div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-xl mx-auto mb-14 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
              <div className="flex justify-between items-center mb-4">
                ...
                <span className="text-2xl font-bold bg-gradient-to-r from-[hsl(210,90%,55%)] to-[hsl(270,70%,60%)] bg-clip-text text-transparent">{hours[0]} hrs</span>
              </div>
              <Slider
                value={hours}
                ...
                max={120}
                step={5}
                className="mb-6 [&_[data-radix-slider-track]]:bg-white/10 [&_[data-radix-slider-range]]:bg-gradient-to-r [&_[data-radix-slider-range]]:from-[hsl(210,90%,55%)] [&_[data-radix-slider-range]]:to-[hsl(270,70%,60%)] [&_[data-radix-slider-thumb]]:bg-[hsl(210,90%,55%)] [&_[data-radix-slider-thumb]]:border-[hsl(270,70%,60%)]"
              />
              <div className="grid grid-cols-3 gap-4 text-center">
                ...
                <div className="bg-[hsl(210,90%,55%)]/10 border border-[hsl(210,90%,55%)]/30 rounded-xl p-4">
                  ...
                  <tbody>
                    {comparisonData.map((row, i) => (
                      <tr key={i} className="border-b border-white/5 last:border-0">
                        ...
                        <td className="p-5 text-white text-sm text-center font-semibold bg-[hsl(210,90%,55%)]/5">{row.retainer}</td>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 max-w-6xl mx-auto">
              {roiItems.map((item, i) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: i * 0.08 }}
                  className="bg-white border border-[#D1D5DB] rounded-2xl p-6 text-center hover:border-[hsl(210,90%,55%)]/30 hover:shadow-lg transition-all duration-300 group"
                >
                  <div className="w-12 h-12 mx-auto mb-4 rounded-xl bg-gradient-to-r from-[hsl(210,90%,55%)]/8 to-[hsl(270,70%,60%)]/8 flex items-center justify-center group-hover:from-[hsl(210,90%,55%)]/15 group-hover:to-[hsl(270,70%,60%)]/15 transition-colors">
                    <item.icon className="w-6 h-6 text-[hsl(210,90%,55%)]" />
                  </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto relative">
              ...
              {deliverySteps.map((step, i) => (
                ...
                >
                  {/* Dot */}
                  <div className="absolute left-8 md:left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-gradient-to-r from-[hsl(210,90%,55%)] to-[hsl(270,70%,60%)] border-4 border-white z-10 shadow-lg" />

                  {/* Content */}
                  <div className={`ml-16 md:ml-0 md:w-[calc(50%-2rem)] ${i % 2 === 0 ? "md:pr-8 md:text-right" : "md:pl-8"}`}>
                    <div className="bg-[#F8FAFC] border border-[#D1D5DB] rounded-2xl p-6 hover:border-[hsl(210,90%,55%)]/30 hover:shadow-lg transition-all duration-300 group inline-block w-full">
                      <div className={`flex items-center gap-3 mb-3 ${i % 2 === 0 ? "md:justify-end" : ""}`}>
                        <div className="w-10 h-10 rounded-xl bg-gradient-to-r from-[hsl(210,90%,55%)]/10 to-[hsl(270,70%,60%)]/10 flex items-center justify-center flex-shrink-0">
                          <step.icon className="w-5 h-5 text-[hsl(210,90%,55%)]" />
                        </div>
                        <span className="text-xs font-bold text-[hsl(210,90%,55%)] uppercase tracking-wider">{step.time}</span>
                      </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              {realProjects.map((proj, i) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: i * 0.1 }}
                  className="bg-white border border-[#D1D5DB] rounded-2xl p-8 text-center hover:border-[hsl(210,90%,55%)]/30 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group"
                >
                  <div className="w-14 h-14 mx-auto mb-5 rounded-2xl bg-gradient-to-r from-[hsl(210,90%,55%)]/10 to-[hsl(270,70%,60%)]/10 flex items-center justify-center group-hover:from-[hsl(210,90%,55%)]/15 group-hover:to-[hsl(270,70%,60%)]/15 transition-colors">
                    <proj.icon className="w-7 h-7 text-[hsl(210,90%,55%)]" />
                  </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
              {addOns.map((addon, i) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: i * 0.08 }}
                  className="bg-[#F8FAFC] border border-[#D1D5DB] rounded-2xl overflow-hidden hover:border-[hsl(210,90%,55%)]/30 hover:shadow-lg transition-all duration-300 group"
                >
                  <div className="h-40 bg-gradient-to-br from-[hsl(210,90%,55%)]/5 to-[hsl(270,70%,60%)]/5 flex items-center justify-center overflow-hidden">
                  ...
                  <div className="p-6">
                    ...
                    <p className="bg-gradient-to-r from-[hsl(210,90%,55%)] to-[hsl(270,70%,60%)] bg-clip-text text-transparent font-bold text-sm mb-2">{addon.price}</p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-5">
                {pricingFactors.map((item, i) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: i * 0.08 }}
                    className="bg-white border border-[#D1D5DB] rounded-2xl p-6 text-center hover:border-[hsl(210,90%,55%)]/40 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group"
                  >
                    <div className="w-14 h-14 mx-auto mb-4 rounded-2xl bg-gradient-to-r from-[hsl(210,90%,55%)]/8 to-[hsl(270,70%,60%)]/8 flex items-center justify-center group-hover:from-[hsl(210,90%,55%)]/15 group-hover:to-[hsl(270,70%,60%)]/15 transition-all">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              ...
              <Accordion type="single" collapsible className="space-y-3">
                {faqs.map((faq, i) => (
                  <AccordionItem key={i} value={`faq-${i}`} className="bg-white border border-[#D1D5DB] rounded-2xl px-6 overflow-hidden data-[state=open]:border-[hsl(210,90%,55%)]/30 transition-colors">
