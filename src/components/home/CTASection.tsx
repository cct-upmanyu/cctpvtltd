      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-primary text-sm font-medium">Start Your Transformation Today</span>
          </motion.div>
          ...
          <p className="text-muted-dark-foreground text-lg md:text-xl max-w-2xl mx-auto mb-12">
          ...
          >
            {[
              ...
              <div
                key={item.text}
                className="flex items-center justify-center gap-2 text-muted-dark-foreground"
              >
                <span>{item.icon}</span>
